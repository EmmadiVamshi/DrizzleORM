...
let UserService = class UserService {
    getTable(type) {
        switch (type) {
            case 'user': return user_entity_1.users;
            case 'product': return product_entity_1.products;
            case 'order': return orders_entity_1.orders;
            case 'payment': return payment_entity_1.payments;
